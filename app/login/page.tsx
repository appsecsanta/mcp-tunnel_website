...
import { getMe, getGitHubLoginURL, getGoogleLoginURL } from '@/lib/api';
      ...
      <main className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          <div className="card p-8">
            ...
            <div className="text-center">
              <p className="text-sm mb-4" style={{ color: 'var(--color-text-secondary)' }}>
                Already have mcpTunnel installed?
              </p>
              <div className="code-block text-sm">
                <span style={{ color: 'var(--color-text-muted)' }}>$</span>{' '}
                <span style={{ color: 'var(--color-cyan)' }}>mcptunnel login</span>
              </div>
            </div>
          </div>
          ...
          <p className="text-center text-sm mt-6" style={{ color: 'var(--color-text-muted)' }}>
            ...
            <a href="/terms" className="hover:underline" style={{ color: 'var(--color-text-secondary)' }}>
              Terms of Service
            </a>{' '}
            and{' '}
            <a href="/privacy" className="hover:underline" style={{ color: 'var(--color-text-secondary)' }}>
              Privacy Policy
            </a>
          </p>
        </div>
